...
if __name__ == "__main__":
    ...
    t.build(m=10, max_m0=20, n_threads=4)
    t.save('HNSW.n10_20_128_1w_L2')

    u = HnswIndex(f, "L2")
    u.load('HNSW.n10_20_128_1w_L2')
    ...
    hd = 100
    for i in range(100):
        nns = u.search_by_vector(querys[i], k, 100, 2, include_distances=True)# 2-SearchById_true() 默认-SearchById_()
